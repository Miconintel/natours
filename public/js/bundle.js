...
var showAlert = function showAlert(type, message) {
  ...
  window.setTimeout(hideAlert, 10000); // to set a time out on a dom element u need to use the dom object.set timeout
};
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _showAlert.showAlert)('success', 'logged in succesfuly');
          ...
          case 8:
            ...
            (0, _showAlert.showAlert)('error', _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') (0, _showAlert.showAlert)('success', 'logged out succesfuly');
          ...
          case 8:
            ...
            (0, _showAlert.showAlert)('error', 'something happened');
...
},{"axios":"../../node_modules/axios/index.js","./showAlert":"showAlert.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
...
var _showAlert = require("./showAlert.js");
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = "".concat(type === 'password' ? 'http://127.0.0.1:8080/api/v1/users/update-password' : 'http://127.0.0.1:8080/api/v1/users/updateme');
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (response.data.status === 'success') {
              (0, _showAlert.showAlert)('success', "".concat(type.toUpperCase(), " updated succesfully"));
              window.setTimeout(function () {
                // location.assign('/me');
                location.reload(true);
              }, 500);
...
},{"axios":"../../node_modules/axios/index.js","./showAlert.js":"showAlert.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe("pk_test_51Kqu9NHVqQpkAuMelrOd8IPdiiFI80yCyJj0GQ6Z9XUng3SlyhrGbljFjKUwfyTRx5s8wXxeMqANZXMV3CChjzw500svbt4gYc");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // use stripe to
          ...
          case 9:
            ...
            (0, _showAlert.showAlert)('error', 'sorry try again there was an error');
...
console.log(bookButton); // console.log(updateForm);
//
//
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  (0, _login.login)(email, password); // updateSettings({ email, password }, 'password');
});
if (logoutButton) logoutButton.addEventListener('click', _login.logout);

if (updateForm) {
  updateForm.addEventListener('submit', function (e) {
    e.preventDefault(); // create a form object programatically
    // this is a wt to create a form with object key value

    var form = new FormData();
    form.append('name', document.querySelector('#name').value);
    form.append('email', document.querySelector('#email').value);
    form.append('photo', document.querySelector('#photo').files[0]); // const name = document.querySelector('#name').value;
...
if (passWordForm) passWordForm.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn--save-password').textContent = 'upating...';
            currentPassword = document.querySelector('#password-current').value;
            newPassword = document.querySelector('#password').value;
            confirmNewPassword = document.querySelector('#password-confirm').value;
            _context.next = 7;
