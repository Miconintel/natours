...
exports.signUp = catchAsync(async (request, response, next) => {
  ...
  // }); this is a hassle will fix later
...
exports.login = catchAsync(async (request, response, next) => {
  ...
  // instance method declared in iuser schema to compare correct method
...
exports.protect = catchAsync(async (request, response, next) => {
  ...
  // we would have returned an error error if the verify didnot return true , but we prefer to catch it directly at catch block
...
exports.forgotPassword = catchAsync(async (request, response, next) => {
  ...
  // const message = `forgot your password submit a patch request with your new passwrd and password confirm to ${url}.\n if you did not forget your password please ignore this email`;
...
exports.updatePassword = catchAsync(async (request, response, next) => {
  ...
  // loguser in try and refactor this
